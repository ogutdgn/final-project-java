...
public class MainFrame extends JFrame {
    ...
    private DefaultListModel<String> rentListModel = new DefaultListModel<>();
    private JList<String> rentCarList = new JList<>(rentListModel);
    
    private DefaultListModel<String> returnListModel = new DefaultListModel<>();
    private JList<String> returnCarList = new JList<>(returnListModel);
    
    private DefaultListModel<String> myCarsListModel = new DefaultListModel<>();
    private JList<String> myCarsList = new JList<>(myCarsListModel);
    ...
    private JPanel createAddCarPanel() {
        ...
        addBtn.addActionListener(e -> {
            ...
            try {
                ...
                carService.addCar(model, plate, year, price, customerService.getLoggedInCustomer());
                modelField.setText("");
                plateField.setText("");
                yearField.setText("");
                priceField.setText("");
    ...
    private void updateReturnCarTab() {
        ...
        for (int i = 0; i < activeRentals.size(); i++) {
            ...
            returnListModel.addElement((i + 1) + ". " + rental.getCar().getMakeModel() + 
